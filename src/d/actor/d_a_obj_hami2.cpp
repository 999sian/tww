...
namespace {
/* 00000B58-00000B78 */
cPhs_State Mthd_Create(void *i_this) { return ((daObjHami2::Act_c *)i_this)->Mthd_Create(); }

/* 00000B78-00000B98 */
BOOL Mthd_Delete(void *i_this) { return ((daObjHami2::Act_c *)i_this)->Mthd_Delete(); }

/* 00000B98-00000BB8 */
BOOL Mthd_Execute(void *i_this) { return ((daObjHami2::Act_c *)i_this)->MoveBGExecute(); }

/* 00000BB8-00000BE4 */
BOOL Mthd_Draw(void *i_this) { return ((daObjHami2::Act_c *)i_this)->Draw(); }

/* 00000BE4-00000C10 */
BOOL Mthd_IsDelete(void *i_this) { return ((daObjHami2::Act_c *)i_this)->IsDelete(); }
